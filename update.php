...
$coneksi = mysqli_connect("localhost" , "root" , "" , "bio" );
   ...
   if (isset($_GET["id"])) {
       $id = $_GET["id"];
       $up = 'SELECT * from londrishow where id="'.$id.'"';
       $mysql = mysqli_query($coneksi, $up);
       $data = mysqli_fetch_assoc($mysql);

       $kode = $data["Kode_Pakaian"];
       $nama      = $data["Nama_pelanggan"];
       $jenis  = $data["Jenis_jasa"];
       $berat = $data["Berat_kg"];
       $tanggal2   = $data["Tanggal_masuk"];
...
<select type="text" name="Kode_Pakaian" value="<?php echo $kode ?>" required >
...
<input type="text" name="Nama_pelanggan" value="<?php echo $nama ?>" readonly="readonly">

<p><b>Jenis Jasa</b></p>
<select type="text" name="Jenis_jasa"value="<?php echo $jenis ?>" required >
...
<p><b>Berat/KG</b></p>
<input type="text" name="Berat_kg" value="<?php echo $berat ?> " required>

<p><b>Tanggal Masuk</b></p>
<input type="date" name="Tanggal_masuk" value="<?php echo $tanggal2 ?>" required>

<p><b>Tanggal Selesai</b></p>
<input type="date" name="Tanggal_selesai" value="<?php echo $tanggal ?>" required>
