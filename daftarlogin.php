...
<body class="w3-light-grey">
  ...
  <h2>Daftar User Londri</h2>
       ...
       <tr>
           <td><?= $s ?></td>
           <td><?= $datakita["nama"] ?></td>
           <td><?= $datakita["alamat"] ?></td>
           <td><?= $datakita["gmail"] ?></td>
           <td><?= $datakita["password"] ?></td>
        
           <td><a style="text-decoration:none;" class="delete" href="hapus2.php?id=<?= $datakita["id"] ?>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a> 
               <a style="text-decoration:none;" class="update" href="updateuser.php?id=<?= $datakita["id"] ?>">Update</a></td>
       </tr>
